...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Vyona'); ?></title>
    ...
    <nav class="sticky top-0 z-50 glass border-b border-modern px-6 py-3">
        <div class="max-w-4xl mx-auto flex items-center justify-between">
            ...
            <div class="flex items-center gap-4">
                <div class="hidden sm:flex items-center gap-3 cursor-pointer group" onclick="window.location='<?php echo e(route('profile.edit')); ?>'">
                    <img src="<?php echo e(Auth::user()->profile_photo_url); ?>" class="w-8 h-8 rounded-full object-cover ring-2 ring-transparent group-hover:ring-blue-500 transition-all" alt="">
                    <span class="text-sm font-semibold text-gray-300 group-hover:text-white transition-colors"><?php echo e(Auth::user()->name); ?></span>
                </div>
            ...
            <?php if(session('success')): ?>
                <div class="max-w-2xl mx-auto mt-4 px-4">
                    <div class="bg-blue-500/10 border border-blue-500/20 text-blue-300 px-4 py-3 text-sm text-center rounded-xl">
                        <i data-lucide="check-circle" class="w-4 h-4 inline -mt-0.5"></i> <?php echo e(session('success')); ?>
...
</html><?php /**PATH C:\laragon\www\vyona\resources\views/layout/app.blade.php ENDPATH**/ ?>