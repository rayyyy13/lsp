...
<?php $__env->startSection('title', 'Edit Postingan — Vyona'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="p-6">
        <form method="POST" action="<?php echo e(route('posts.update', $post->id)); ?>" enctype="multipart/form-data" class="space-y-4">
            ...
            <div>
                <textarea name="content" maxlength="250" required
                    ...
                    oninput="document.getElementById('eCharCount').textContent=250-this.value.length"><?php echo e(old('content', $post->content)); ?></textarea>
                <span id="eCharCount" class="text-xs text-gray-600 mt-1 block"><?php echo e(250 - strlen(old('content', $post->content))); ?></span>
            </div>
            ...
            <?php if($post->image_path): ?>
                <div class="relative inline-block">
                    <img src="<?php echo e(Storage::url($post->image_path)); ?>" class="rounded-xl max-h-[200px] border border-modern ring-1 ring-white/5" alt="">
                    <p class="text-xs text-gray-600 mt-1">Gambar saat ini (upload baru untuk mengganti)</p>
                </div>
            <?php endif; ?>
            <?php if($post->file_path): ?>
                <p class="text-xs text-gray-600">📎 File saat ini: <?php echo e($post->file_name); ?> (upload baru untuk mengganti)</p>
            <?php endif; ?>
...
<?php echo $__env->make('layout.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\vyona\resources\views/posts/edit.blade.php ENDPATH**/ ?>