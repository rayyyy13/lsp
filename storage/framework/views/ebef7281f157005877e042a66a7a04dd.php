...
<body class="flex items-center justify-center min-h-screen p-4">
    ...
    <span class="text-white text-3xl font-black tracking-tighter">V</span>
            ...
            <form method="POST" action="<?php echo e(route('register')); ?>" class="space-y-4">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="col-span-2 sm:col-span-1">
                        ...
                        <input type="text" name="name" value="<?php echo e(old('name')); ?>" required class="input-modern w-full rounded-xl px-4 py-3 text-white placeholder-gray-600">
                    </div>
                    <div class="col-span-2 sm:col-span-1">
                        <label class="block text-sm font-medium text-gray-400 mb-2">Username</label>
                        <input type="text" name="username" value="<?php echo e(old('username')); ?>" required class="input-modern w-full rounded-xl px-4 py-3 text-white placeholder-gray-600">
                    </div>
                </div>
                <div>
        ...
        <p class="text-gray-500 text-sm mt-6 text-center">Sudah punya akun? <a href="<?php echo e(route('login')); ?>" class="text-blue-400 hover:text-blue-300 font-semibold hover:underline">Masuk</a></p>
    </div>
</body>
</html><?php /**PATH C:\laragon\www\vyona\resources\views/auth/register.blade.php ENDPATH**/ ?>